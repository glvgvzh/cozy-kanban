    ...
    >
      {!isEditingTitle ? (
        ...
        <div className="task-line">
          ...
          <div
            className="title-char-counter"
            style={{ color: `${titleCharCounter > 99 ? 'var(--danger)' : ''}` }}
          >
          ...
          <input
            ...
            onChange={(e) =>
              onUpdateTask(selectedTask.id, {
                deadline: e.target.value === '' ? '' : Date.parse(e.target.value),
              })
            }
          />
        </div>
      ...
      {!isEditingDescription ? (
        selectedTask.description && (
          <div className="task-modal-description">{selectedTask.description}</div>
        )
      ) : (
        <textarea
